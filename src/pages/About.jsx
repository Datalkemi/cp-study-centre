      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            */}
            { [
              { name: 'Alice Johnson', role: 'Founder & CEO', avatar: '/path/to/alice.jpg', bio: 'Education strategist with 10+ years of experience.' },
              { name: 'Raj Patel', role: 'Head of Academics', avatar: '/path/to/raj.jpg', bio: 'Expert tutor and curriculum designer.' },
              { name: 'Maria Gomez', role: 'Tech Lead', avatar: '/path/to/maria.jpg', bio: 'Focused on building seamless digital experiences.' },
              { name: 'Liu Wei', role: 'Student Success', avatar: '/path/to/liu.jpg', bio: 'Dedicated to guiding students towards their goals.' },
            ].map((member) => (
              <div key={member.name} className="relative group">
                ...
                <div className="absolute inset-0 bg-white bg-opacity-90 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center p-4 text-center">
